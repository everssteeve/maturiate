...
import type { EvolutionPoint } from "@/lib/queries/team-dashboard";
...
export function TeamEvolutionChart({ data }: TeamEvolutionChartProps) {
  ...
  const chartData = data.map((point) => ({
    name: point.label,
    global: point.globalScore,
    ...Object.fromEntries(
      DIMENSIONS.map((dim) => [dim.id, point.dimensionScores[dim.id] ?? null]),
    ),
  }));
